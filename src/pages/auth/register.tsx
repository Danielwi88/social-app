  ...
  const mutate = useMutation({
    ...
    onSuccess: async (res) => {
      ...
      try {
        ...
        toast.success("Account created", { description: `Welcome, ${me.displayName}!` });
        nav("/feed", { replace: true });
      } catch {
        dispatch(clearAuth());
        toast.error("Registration failed", { description: "Could not load account data." });
      }
    },
    onError: () => {
      toast.error("Registration failed", { description: "Make sure email and username are unique." });
    },
  });
    ...
    <div className="relative flex min-h-dvh items-center justify-center overflow-hidden bg-black px-4 py-16 sm:px-6">
      ...
      <div className="relative w-full max-w-md rounded-[32px] border border-white/10 bg-black/40 p-8 text-white shadow-[0_25px_80px_rgba(0,0,0,0.45)] backdrop-blur-xl sm:p-10">
        <div className="flex flex-col items-center gap-3 text-center">
          ...
          <p className="text-sm text-white/60">Create your account to join the community.</p>
        </div>
          ...
          <FormField
            ...
            input={
              <Input
                ...
                className={cn(inputBase, formState.errors.name ? inputError : inputOk)}
              />
            }
          />
          ...
          <FormField
            ...
            input={
              <Input
                ...
                className={cn(inputBase, formState.errors.username ? inputError : inputOk)}
              />
            }
          />
          ...
          <FormField
            ...
            input={
              <Input
                ...
                className={cn(inputBase, formState.errors.email ? inputError : inputOk)}
              />
            }
          />
          ...
          <FormField
            ...
            input={
              <Input
                ...
                className={cn(inputBase, formState.errors.phone ? inputError : inputOk)}
              />
            }
          />
...
function FormField({ label, error, input, trailing }: FormFieldProps) {
  return (
    <div className="space-y-2">
      ...
      <div className="relative flex items-center">{input}{trailing}</div>
