      ...
      <div className="relative w-full max-w-md rounded-[32px] border border-white/10 bg-black/40 p-8 text-white shadow-[0_25px_80px_rgba(0,0,0,0.45)] backdrop-blur-xl sm:p-10">
        ...
        >
          ...
          <Button
            ...
            className="mt-3 text-md font-bold h-12 w-full rounded-full bg-primary-300 hover:bg-gradient-to-r from-[#5613A3] to-[#522BC8] shadow-[0_10px_40px_rgba(86,19,163,0.35)] hover:scale-105 hover:-translate-y-0.5 !text-white "
          >
